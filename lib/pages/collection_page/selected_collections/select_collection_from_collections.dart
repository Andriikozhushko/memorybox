      ...
      if (isSelected) {
        ...
        futures.add(collectionRef.get().then((docSnapshot) {
          if (docSnapshot.exists) {
            ...
            bool alreadyExists = existingAudios.any((audio) =>
                audio['audioFileName'] == widget.audioData!.audioFileName);

            if (alreadyExists) return;

            int durationInSeconds = widget.audioData!.durationInSeconds * 60 +
                widget.audioData!.durationSeconds;
            ...
            batch.update(collectionRef, {
              'audioFiles': FieldValue.arrayUnion([
                {
                  'audioFileName': widget.audioData!.audioFileName,
